...
SOURCEFILES_QUOTED_IF_SPACED=anRead.c binled.c buttonInterrupts.c dc_motor.c eusart.c lcd.c servoControl.c rfid_reader.c ir_handling.c navigation.c main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/anRead.p1 ${OBJECTDIR}/binled.p1 ${OBJECTDIR}/buttonInterrupts.p1 ${OBJECTDIR}/dc_motor.p1 ${OBJECTDIR}/eusart.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/servoControl.p1 ${OBJECTDIR}/rfid_reader.p1 ${OBJECTDIR}/ir_handling.p1 ${OBJECTDIR}/navigation.p1 ${OBJECTDIR}/main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/anRead.p1.d ${OBJECTDIR}/binled.p1.d ${OBJECTDIR}/buttonInterrupts.p1.d ${OBJECTDIR}/dc_motor.p1.d ${OBJECTDIR}/eusart.p1.d ${OBJECTDIR}/lcd.p1.d ${OBJECTDIR}/servoControl.p1.d ${OBJECTDIR}/rfid_reader.p1.d ${OBJECTDIR}/ir_handling.p1.d ${OBJECTDIR}/navigation.p1.d ${OBJECTDIR}/main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/anRead.p1 ${OBJECTDIR}/binled.p1 ${OBJECTDIR}/buttonInterrupts.p1 ${OBJECTDIR}/dc_motor.p1 ${OBJECTDIR}/eusart.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/servoControl.p1 ${OBJECTDIR}/rfid_reader.p1 ${OBJECTDIR}/ir_handling.p1 ${OBJECTDIR}/navigation.p1 ${OBJECTDIR}/main.p1

# Source Files
SOURCEFILES=anRead.c binled.c buttonInterrupts.c dc_motor.c eusart.c lcd.c servoControl.c rfid_reader.c ir_handling.c navigation.c main.c
...
${OBJECTDIR}/servoControl.p1: servoControl.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/servoControl.p1.d 
	@${RM} ${OBJECTDIR}/servoControl.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/servoControl.p1  servoControl.c 
...
dist/${CND_CONF}/${IMAGE_TYPE}/ECM.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/ECM.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     --rom=default,-1dc0-1fff --ram=default,-2f4-2ff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/ECM.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/ECM.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/ECM.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/ECM.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/ECM.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
